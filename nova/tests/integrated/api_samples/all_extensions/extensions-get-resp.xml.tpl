...
<extensions xmlns:atom="http://www.w3.org/2005/Atom" xmlns="http://docs.openstack.org/common/api/v1.0">
  ...
  <extension alias="rax-si-image-schedule" updated="%(timestamp)s" namespace="http://docs.openstack.org/servers/api/ext/scheduled_images/v1.0" name="ScheduledImages">
    <description>%(text)s</description>
  </extension>
